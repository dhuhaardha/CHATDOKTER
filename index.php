...
<body>
    <div class="container">
        ...
        <h3 align="center">Medical Chat Dokter</h3><br />
        <br />
        <div class="row">

            <a href="register.php"><button type="button" class="btn btn-warning btn-xs">Register
                    User</button></a>

            <a href="register_dokter.php"><button type="button" class="btn btn-warning btn-xs">Register
                    Dokter</button></a>
            <a href="register_admin.php"><button type="button" class="btn btn-warning btn-xs">Register
                    Admin</button></a>
        ...
        <div class="table-responsive" class="row">
            ...
            <div id="user_details" class="column"></div>
            <div id="chat_details" class="column"></div>
            <div id="user_model_details"></div>
        </div>
        <div class="table-responsive" class="row" style="padding-top: 30px;">

            <div id="payment_details" class="column"></div>
        </div>
        <br />
        <br />
...
$(document).ready(function() {
    ...
    function fetch_chat_message_data() {
        $.ajax({
            url: "fetch_chat_message_data.php",
            method: "POST",
            success: function(data) {
                $('#chat_details').html(data);
            }
        })
    }
