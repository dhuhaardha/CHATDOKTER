...
<body>
    ...
    <br>
    <form action="createpayment.php?id=<?php echo "$kode" ?>" method="POST">
        <div class="row">
            <div class="col-75">
                <div class="container">
                    <form action="">
                        ...
                        <div class="row">
                            <div class="col-50">
                                <h3 align="center" style="margin-bottom:3rem;">Data Pasien</h3>
                                ...
                                <input type="text" id="email" name="email" placeholder="---@woody.com">
                                <label for="adr"><i class="fa fa-home"></i> Alamat</label>
                                <input type="text" id="almt" name="alamat" placeholder="---">
                                <label for=" notelpon" style="padding-bottom: 3px"><i class="fa fa-phone"></i>
                                    No.Telpon</label>
                                <input type="text" id="nohp" name="no_telpon" placeholder="---">

                                <h3 align="center" style="margin-bottom:3rem;">Payment</h3>
